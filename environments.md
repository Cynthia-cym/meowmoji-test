...
| 用途 | 地址 | 说明 |
| --- | --- | --- |
| CMS 运营后台（浏览器） | `https://meowmoji-cms01.vercel.app` 或台式机本地 `http://<台式机局域网IP>:5173` | MacBook 测 CMS 时用局域网 IP |
| CMS 接口（仅联调参考） | `http://1.14.147.241:18180` | staging，云函数已指向此处 |
| 小程序 | 微信开发者工具 · 体验版/开发版 | 运行目录以 Codex 本地 `WeChatProjects/meowmoji` 为准 |
...
| C 端测试邮箱 | `accept-v2@meowmoji.test` | 邮箱验证码；备案前可能 `EMAIL_PROVIDER_MISSING` |

...
> **修订（2026-07-07）：** 已上架服务通知并入 MP-F6-010，CMS 获取短链后验收「表情专辑已上架」站内信 + 微信服务通知  
...
客服工单 · 微信 API 上架 · 移动 CMS · **云 headless / Puppeteer 主路径上架**（ADR-017 已证伪）。已上架服务通知不再作为 F10 范围外项，改由 MP-F6-010 覆盖。
